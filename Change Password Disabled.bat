...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\System" /v "AllowSignInOptions" /t REG_DWORD /d 0 /f

echo Disabling Security Key Sign-in...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\System" /v "EnableSecurityKeySignIn" /t REG_DWORD /d 0 /f
